...
export const dict = {
  ...
  "page.mcp.description": "{{connected}} of {{total}} connected",
  "page.mcp.cards": "Servers",
  "page.plugins.title": "Plugins",
  "page.plugins.description": "{{active}} of {{total}} active",
  ...
  "mcp.add.type.remote": "Remote",
  "mcp.add.command": "Command",
  "mcp.add.url": "URL",
  "mcp.add.enabled": "Enabled",
  "mcp.add.submit": "Add",
  "mcp.add.added": "Added {{name}}",
  "mcp.delete.removed": "Removed {{name}}",
  "mcp.json.cancel": "Cancel",
  "mcp.json.edit": "Edit",
  "mcp.json.editNotice": "Editing the JSON directly will replace the full MCP configuration. Be careful with syntax.",
  "mcp.json.parseError": "JSON syntax error",
  "mcp.json.title": "MCP configuration (JSON)",
  "mcp.json.save": "Save",
  "mcp.json.reset": "Reset",
  "mcp.json.invalid": "Invalid JSON",
  "mcp.json.saved": "Configuration saved",
  "mcp.offlineBadge": "Offline (local only)",
  "mcp.json.savedLocal": "Saved locally (server offline)",
  ...
  "settings.general.row.showSidebar.title": "Show left sidebar",
  "settings.general.row.showSidebar.description": "Keep the projects sidebar visible even on narrow windows.",
}
