export const dict = {
  ...
  "page.mcp.title": "Servidores MCP",
  "page.mcp.description": "{{connected}} de {{total}} conectados",
  "page.mcp.cards": "Servidores",
  "page.plugins.title": "Plugins",
  "page.plugins.description": "{{active}} de {{total}} activos",
  "plugins.state.active": "Activo",
  "plugins.state.inactive": "Inactivo",
  "mcp.add": "Agregar MCP",
  "mcp.add.name": "Nombre",
  "mcp.add.type": "Tipo",
  "mcp.add.type.local": "Local",
  "mcp.add.type.remote": "Remoto",
  "mcp.add.command": "Comando",
  "mcp.add.url": "URL",
  "mcp.add.enabled": "Habilitado",
  "mcp.add.submit": "Agregar",
  "mcp.add.added": "{{name}} agregado",
  "mcp.delete.removed": "{{name}} eliminado",
  "mcp.json.cancel": "Cancelar",
  "mcp.json.edit": "Editar",
  "mcp.json.editNotice": "Editar el JSON directamente reemplazará toda la configuración MCP. Ten cuidado con la sintaxis.",
  "mcp.json.parseError": "Error de sintaxis JSON",
  "mcp.json.title": "Configuración MCP (JSON)",
  "mcp.json.save": "Guardar",
  "mcp.json.reset": "Restablecer",
  "mcp.json.invalid": "JSON inválido",
  "mcp.json.saved": "Configuración guardada",
  "prompt.mcp.title": "Servidores MCP",
  "prompt.plugins.title": "Plugins",
  "settings.general.section.uiux": "Diseño de interfaz",
  "settings.general.row.showSidebar.title": "Mostrar menú lateral izquierdo",
  "settings.general.row.showSidebar.description": "Mantener visible la barra lateral de proyectos incluso en ventanas angostas.",
}
